          ...
          <div className="grid-x align-center-middle">
            <div className="cell medium-10 large-8">
              <ul className="tabs" data-deep-link="true" data-tabs id="example-tabs">
                <li className="tabs-title tabs-title-active"><Link to={`/about/centers`}>Centers of Excellence</Link></li>
                <li className="tabs-title"><Link to={`/about/people`}>People</Link></li>
              </ul>
